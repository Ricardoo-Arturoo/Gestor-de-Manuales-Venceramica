...
<script setup>
// Definimos las propiedades que este componente puede recibir
defineProps({
  titulo: {
    type: String,
    required: true
  ...
  subtitulo: {
    type: String,
    default: 'Ver más' // Si no le pasas subtítulo, dirá "Ver más"
  }
})

// Declaramos que este componente puede emitir un evento 'click'
defineEmits(['click'])
</script>