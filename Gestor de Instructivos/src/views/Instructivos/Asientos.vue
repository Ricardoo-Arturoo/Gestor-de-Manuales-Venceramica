...
const cargarAsientos = async () => {
  try {
    ...
    asientos.value = datosObtenidos.filter(h => h.clasificacion === 'Instructivo')
...
<template>
  <div class="flex h-screen w-full bg-gray-50 font-sans overflow-hidden">
    ...
    <main class="flex-1 w-full h-full overflow-y-auto pt-20 px-6 pb-12 md:p-12 relative">
      <HeaderVista titulo="Instructivos de Asientos" descripcion="Seleccione el modelo de asiento para descargar su instructivo." />
